...
import { DollarSign, TrendingUp, TrendingDown, Calendar, PieChart, BarChart3, ArrowUpRight } from 'lucide-react';
...
const Financial: React.FC = () => {
  ...
  const loadCloudData = async () => {
    // 1. Transactions (Async Cloud)
    const txs = await FinanceService.api.getTransactions();
    setTransactions(txs);

      // 2. Professionals & Services (Async Cloud)
      ...
      // 3. Local Data (Still local for now)
